...
import { BsTicketPerforated, BsQrCode, BsArrowLeft } from '@/icon-adapters/react-icons/bs';
import { FiSend, FiX, FiCopy, FiCheck, FiArrowDownLeft } from '@/icon-adapters/react-icons/fi';
import { Link2 } from '@/icon-adapters/lucide-react';
